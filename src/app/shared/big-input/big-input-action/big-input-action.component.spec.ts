...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<ansm-big-input-action></ansm-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<ansm-big-input-action [disabled]="true"></ansm-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template =
      '<ansm-big-input-action fontSet="fas" fontIcon="fa-trash"></ansm-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template =
      '<ansm-big-input-action label="delete"></ansm-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template =
      '<ansm-big-input-action (action)="actionHandler()"></ansm-big-input-action>';
    fixture = createHostComponent(template);
